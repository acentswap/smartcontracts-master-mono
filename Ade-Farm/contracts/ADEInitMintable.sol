...
contract ADEInitMintable is ERC20("ADEToken", "ADE"), Ownable {
    ...
    function distributeSupply(
        ...
        require(block.timestamp >= nextDistributionTimestamp, "ADEInitMintable: Not ready");
        require(_teamAddresses.length == _teamAmounts.length, "ADEInitMintable: Array length mismatch");
