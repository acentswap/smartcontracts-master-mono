...
enum RouterVersion {
  ADERouter01 = 'ADERouter01',
  ADERouter02 = 'ADERouter02'
}

describe('ADERouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.ADERouter01]: fixture.router01,
        [RouterVersion.ADERouter02]: fixture.router02
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.ADERouter01]: 102328,
              [RouterVersion.ADERouter02]: 102338
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
